        ...
        <div class="table-responsive">
            <table class="table" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <?php if (empty($gases)): ?>
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 30px; color: #999;">No gases found. Start by adding a new gas from the Add New menu.</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
$(document).ready(function() {
    ...
    function displayGasLogs(batches) {
        ...
        if (batches.length === 0) {
            html += `
                <tr>
                    <td colspan="8" style="padding: 20px; text-align: center; color: #999;">No batch logs found.</td>
                </tr>
            `;
        } else {
